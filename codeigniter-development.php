...
<body>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6 text-center">
            <img src="assets/img/about/code.png" alt="Our Story" class="img-fluid" style="max-width: 90%; height: auto;">
        </div>

        <!-- Content Section -->
        <div class="col-12 col-md-6">
            <h3 class="mb-3 text-md-start text-center" 
                style="font-weight:bold; font-size: 30px; padding-top: 20px; color: #333;">
                CodeIgniter Development
            </h3>
            <p class="text-dark" 
               style="font-size: 17px; text-align: justify; line-height: 26px; color: #444;">
                CodeIgniter has been known as a lightweight framework for developing web applications. 
                As a developer, choosing the right framework depends on several factors such as 
                stability, documentation, support, features, and real-world applications. 
                Researching these aspects helps in making an informed decision.
            </p>
        </div>
    </div>
</div>
...
<div class="container py-0 pb-0">
    <div class="row align-items-center flex-md-row-reverse">
        <!-- Image Section -->
        <div class="col-12 col-md-6 text-center">
            <img src="assets/img/about/code-1.png" alt="Our Story" class="img-fluid" style="max-width: 90%; height: auto;">
        </div>
        ...
        <div class="col-12 col-md-6">
            <p class="text-dark" 
               style="font-size: 17px; text-align: justify; line-height: 26px; color: #444;">
                CodeIgniter is widely chosen due to its simplicity and efficiency. 
                Developers need to evaluate key aspects like framework stability, 
                ease of documentation, community support, and project examples 
                before deciding on the best fit for their application needs.
            </p>
        </div>
    </div>
</div>
    ...
    <div class="sotcox-details-page sotcox-team-details-page sotcox-service-details-page pt-3 pb-0">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    <div class="sotcox-section-heading text-center mb-0">

                        <h2 class="heading" style="font-size: 30px;">
                            We provide
                            solutions
                ...
                <div class="col-xl-12 col-lg-12 pb-5">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 mt-30">
                            <div class="stocox-support-box wow fadeInUp" data-wow-delay="200ms"
                                data-wow-duration="800ms"
                                style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; height: 370px;">
                                <div class="icon">
                                    <img src="assets/img/icons/service-details-icon-2.png" alt="">
                                </div>
                                <div class="content mt-25">
                                    <h4 class="titles">
                                        <h4 class="titles">MVC Architecture
                                        </h4>
                                        <p>


                                            All our programmers are proficient in comprehending and handling the
                                            Model-View-Controller architecture, which ultimately provides easy
                            ...
                            <div class="stocox-support-box wow fadeInUp" data-wow-delay="200ms"
                                ...
                                <div class="content mt-25">
                                    ...
                                    <p>
                                        ...
                                        Our team seamlessly integrates third-party services such as payment gateway
                                        solutions, email services, social media, analytics in order to make scalable and
                                        reliable applications.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 mt-30">
                            <div class="stocox-support-box wow fadeInUp" data-wow-delay="400ms"
                                data-wow-duration="800ms"
                                style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; height: 370px;">
                                <div class="icon">
                                ...
                                <div class="content mt-25">
                                    ...
                                    <p>
                                        ...
                                        This framework provides support to different data platforms (Linux, Mac OS,
                                        Windows). We work on all these platforms to implement CodeIgniter and attain
                                        better solutions.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stocox-support-box wow fadeInUp" data-wow-delay="400ms"
                                ...
                                <div class="content mt-25">
                                    ...
                                    <p>
                                        ...
                                        We have extensive experience in working with various PHP frameworks with each
                                        functionality parameter and unparalleled customization skills.
                            ...
                            <div class="stocox-support-box wow fadeInUp" data-wow-delay="400ms"
                                ...
                                <div class="content mt-25">
                                    ...
                                    <p>
                                        ...
                                        Our developers are updated with all the latest versions of PHP language and its
                                        configurations. Being abreast with all the industry trends, they can offer
                                        error-free and genuine implementation of CodeIgniter..</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stocox-support-box wow fadeInUp" data-wow-delay="400ms"
                                ...
                                <div class="content mt-25">
                                    ...
                                    <p>
                                        ...
                                        We provide you a powerful & secure back-end support to ensure the security of
                                        your data. Comprehensive and extremely flexible solutions promise the cutting
                                        edge web application for your business needs.</p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container py-2 pb-5" style="text-align: center;">
        <div class="row align-items-center">
            <!-- Image Section -->
            <h4 style="font-size:25px">Codeigniter Framework Development Services</h4>
            <!-- Content Section -->
            <div class="col-12 col-md-12">

                <p class="text-dark pt-3" style="font-size: 17px; color:black; text-align: justify;line-height:25px;">

                    Codeigniter it has been known as a lightweight framework for developing web applications. For you as
                    a developer in order to make a decision on which framework to be used in your project it depends on
                    various factors. You need to research on factors like framework stability, documentation, support,
                    features, and even examples of projects using such framework.
            ...
            <div class="row pt-5">
                ...
                <div class="col-lg-4 ">
                    ...
                    <ul>
                        <li class="text-start">CodeIgniter website development
                        </li>
                        ...
                        <li class="text-start">Portal development</li>
                        <ul>
                ...
                <div class="col-lg-4 ">
                    ...
                    <ul>
                        <li class="text-start">eCommerce development application migration
                        ...
                        <li class="text-start">
                            CodeIgniter application development</li>
                        <ul>
