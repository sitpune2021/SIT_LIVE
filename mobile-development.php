...
<body>
    ...
    <div class="sotcox-details-page sotcox-team-details-page sotcox-service-details-page pt-2 pb-5">
        <div class="container">
                ...
                <div class="col-xl-12">
                    <div class="details-wrapper pr-25">
                        ...
                        <div class="details-content mt-60">
                            ...
                            <h2 class="sotcox-title mt-2 mb-3">Mobile Application Types </h2>
            ...
            <div class="row mt-20">
                <div class="col-xl-12"><h2 class="sotcox-title mt-3 mb-0">Our Offerings </h2>
                </div>
 ...
 <div class="sotcox-details-page sotcox-team-details-page sotcox-service-details-page pt-0 pb-5">
        <div class="container">
      <div class="row mt-0">
                <div class="col-xl-12"><h2 class="sotcox-title mt-1 mb-0">Mobile App Developement Solutions </h2>
                </div>
                <div class="col-xl-12 col-lg-12">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6 mt-30">
