                                    ...
                                    <ul>
                                        ...
                                        <li><a href="services.php">Services</a>
                                            <!--     <ul class="sub-menu" >
                                                ...
                                                <li><a href="claravel-development.php">Laravel Development</a></li>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6">
                ...
                <p class="text-dark" style="font-size: 17px; color:black; text-align: justify;line-height:25px;">
                    ...
                    Our outstanding Laravel programmers superbly know how to get full preferred standpoint of such a
                    framework and create special applications that satisfy your clients. We build simple as well as
                    complex enterprise-grade Laravel applications for all business types. With dedicated Laravel
                    developers, we deliver high quality and secure web apps at the most competitive rates.
                </p>
            </div>
        </div>
    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="stocox-support-box"
                                style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; height: 300px; padding: 20px; text-align: center;">
                                <div class="icon">
                                    <img src="assets/img/icons/service-details-icon-1.png" alt="Social Media"
                                        style="max-width: 80px; height: auto;">
                                </div>
                                <div class="content mt-3">
                                    <h4 class="titles mb-3" style="font-size: 1.25rem;">Social Media</h4>
                                    <p style="text-align: justify; font-size: 0.95rem;">Social media is one of the
                                        biggest stages of business execution. Social media helps to make brand
                                        awareness, promote your image and in particular assistance for notoriety the
                                        board as well.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="stocox-support-box"
                                ...
                                <div class="content mt-3">
                                    <h4 class="titles mb-3" style="font-size: 1.25rem;">Ad Campaigns</h4>
                                    <p style="text-align: justify; font-size: 0.95rem;">Reaching your audience on social
                                        is no longer organic. We are experts at amplifying ROI, achieving the precise
                                        people wanted with the most up-to-date and consistently changing social media
                                        and tools.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="stocox-support-box"
                                ...
                                <div class="content mt-3">
                                    <h4 class="titles mb-3" style="font-size: 1.25rem;">Social Strategy</h4>
                                    <p style="text-align: justify; font-size: 0.95rem;">Social strategy isn’t just about
                                        posting and submissions. It’s tied in with making a vision first, then
                                        understanding that vision through key media and content that drives new
                                        opportunities.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="stocox-support-box"
                                ...
                                <div class="content mt-3">
                                    <h4 class="titles" style="font-size: 1.25rem;">Data Reports and Analysis</h4>
                                    <p style="text-align: justify; font-size: 0.95rem;">How important is it to spend
                                        money on the right investment and time to make success unless there is the
                                        ability to measure that success?</p>
                                </div>
                            </div>
                        </div>
