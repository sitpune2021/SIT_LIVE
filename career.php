...
<body>
 ...
 <aside class="side-info-wrapper show-all">
    ...
    <!-- Category Start -->
<div class="container-xxl py-3" style="background-color: #f8f9fa;">
    <div class="container">
        <h1 class="text-center mb-3 wow fadeInUp" style="font-weight: bold; color: #333;" data-wow-delay="0.1s">
            Explore By Category
        </h1>
        <div class="row g-4">
            <!-- Category Card 1 -->
            <div class="col-lg-3 col-md-4 col-sm-6 wow fadeInUp" style="padding: 15px;" data-wow-delay="0.1s">
                <a class="cat-item rounded p-4 d-flex flex-column align-items-center text-center" style="background-color: #fff; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); text-decoration: none; color: #333;">
                    <i class="fa fa-3x fa-mail-bulk text-primary mb-4"></i>
                    <h6 class="mb-3">Marketing</h6>
                    <!-- <p class="mb-0" style="font-size: 14px; color: #666;">123 Vacancy</p> -->
                </a>
            </div>
            <!-- Category Card 2 -->
            <div class="col-lg-3 col-md-4 col-sm-6 wow fadeInUp" style="padding: 15px;" data-wow-delay="0.3s">
                <a class="cat-item rounded p-4 d-flex flex-column align-items-center text-center"  style="background-color: #fff; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); text-decoration: none; color: #333;">
            ...
            <!-- Category Card 3 -->
            <div class="col-lg-3 col-md-4 col-sm-6 wow fadeInUp" style="padding: 15px;" data-wow-delay="0.5s">
                <a class="cat-item rounded p-4 d-flex flex-column align-items-center text-center"  style="background-color: #fff; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); text-decoration: none; color: #333;">
            ...
            <!-- Category Card 4 -->
            <div class="col-lg-3 col-md-4 col-sm-6 wow fadeInUp" style="padding: 15px;" data-wow-delay="0.7s">
                <a class="cat-item rounded p-4 d-flex flex-column align-items-center text-center"  style="background-color: #fff; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); text-decoration: none; color: #333;">
...
<!-- Category End -->
    ...
    <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6 text-center">
            <img src="assets/img/about/Recruitment-professionals.jpg" alt="Our Story" class="img-fluid"
                style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; border-radius: 20px;">
        </div>

        <!-- Content Section -->
        <div class="col-12 col-md-6">
            <h1 class="mb-1 mt-3" style="font-size: 30px;">We Help To Get The Best Job And Find A Talent</h1>
...
<div class="container-xxl py-0">
    <div class="container">
        <h1 class="text-center mb-3" style="animation: fadeInUp 0.3s;">Join Our Team</h1>
        <div class="text-center">
            <!-- Tabs Navigation -->
            <ul class="nav nav-tabs justify-content-center" id="jobTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="featured-tab" data-bs-toggle="tab" data-bs-target="#featured" type="button" role="tab" aria-controls="featured" aria-selected="true">Open Job</button>
                </li>
        ...
        <!-- Tabs Content -->
        <div class="tab-content mb-5" id="jobTabsContent">
            <!-- Featured Tab -->
            <div class="tab-pane fade show active" id="featured" role="tabpanel" aria-labelledby="featured-tab">
                <div class="job-item p-4 mb-4" style="border: 1px solid #ddd; border-radius: 8px;">
                    <div class="row g-4">
                        <div class="col-12 col-md-8 d-flex align-items-center">
                            <img src="assets/img/about/marketing-manager.jpg" alt="Creative Director" style="width: 80px; height: 80px; border: 1px solid #ddd; border-radius: 8px;">
                            <div class="ms-3">
                                <h5 class="mb-2">Creative Director</h5>
                                <p class="mb-1">
                        ...
                        <div class="col-12 col-md-4 text-md-end">
                            <a class="btn btn-light me-2" href="#"><i class="far fa-heart text-primary"></i></a>
                            <a class="btn btn-primary" href="job_details.php">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="fulltime" role="tabpanel" aria-labelledby="fulltime-tab">
                <div class="job-item p-4 mb-4" style="border: 1px solid #ddd; border-radius: 8px;">
                    <div class="row g-4">
                        <div class="col-12 col-md-8 d-flex align-items-center">
                            <img src="assets/img/about/marketing-manager.jpg" alt="Software Engineer" style="width: 80px; height: 80px; border: 1px solid #ddd; border-radius: 8px;">
                            <div class="ms-3">
                                <h5 class="mb-2">Software Engineer</h5>
                                <p class="mb-1">
                                    <i class="fa fa-map-marker-alt text-primary me-2"></i>New York, USA
                                    <i class="far fa-clock text-primary mx-2"></i>Full Time
                                    <i class="far fa-money-bill-alt text-primary mx-2"></i>$123 - $456
                                </p>
                                <small><i class="far fa-calendar-alt text-primary me-2"></i>Date Line: 01 Jan, 2045</small>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 text-md-end">
                            <a class="btn btn-light me-2" href="#"><i class="far fa-heart text-primary"></i></a>
            ...
            <div class="tab-pane fade" id="parttime" role="tabpanel" aria-labelledby="parttime-tab">
                <div class="job-item p-4 mb-4" style="border: 1px solid #ddd; border-radius: 8px;">
                    <div class="row g-4">
                        <div class="col-12 col-md-8 d-flex align-items-center">
                            <img src="assets/img/about/marketing-manager.jpg" alt="Marketing Manager" style="width: 80px; height: 80px; border: 1px solid #ddd; border-radius: 8px;">
                            <div class="ms-3">
                                <h5 class="mb-2">Marketing Manager</h5>
                                <p class="mb-1">
                                    <i class="fa fa-map-marker-alt text-primary me-2"></i>New York, USA
                                    <i class="far fa-clock text-primary mx-2"></i>Part Time
                                    <i class="far fa-money-bill-alt text-primary mx-2"></i>$123 - $456
                                </p>
                                <small><i class="far fa-calendar-alt text-primary me-2"></i>Date Line: 01 Jan, 2045</small>
                            </div>
