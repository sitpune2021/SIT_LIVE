...
<!-- content start form here -->
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 mt-0">
                            <div class="stocox-support-box wow fadeInUp" data-wow-delay="00ms" data-wow-duration="800ms" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; ">
                                ...
                                <div class="content mt-25">
                                    <h4 class="titles">HTML5, Bootstrap, jQuery</h4>
                                   <p>
             At the core of each site is an HTML script. Hyper Text Markup Language or HTML is the standard markup language used for making website pages. It is the essential building blocks or framework for how each every site on the web is assembled.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-md-6 mt-0">
                            <div class="stocox-support-box wow fadeInUp" data-wow-delay="200ms" data-wow-duration="800ms" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; ">
                                ...
                                <div class="content mt-25">
                                    <h4 class="titles">Angular JS, KendoUI, Knockout, D3js</h4>
                                 <p>
            AngularJS is an open-source JavaScript framework, kept up by Google, that helps with running single-page applications. Almost certainly angularJS has intended to make front-end advancement as simple...
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 mt-0">
                            <div class="stocox-support-box wow fadeInUp" data-wow-delay="400ms" data-wow-duration="800ms" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; ">
                                ...
                                <div class="content mt-25">
                                    <h4 class="titles">Android Development </h4>
                                  <p>
             SIT has elevated its Android development expertise by making a different division implied solely for big business level android development. This division is a characteristic augmentation to our offer as one of the best portable...
            </p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-12 col-md-6 text-center">
            <img src="assets/img/about/uiux.jpg" alt="Our Story" class="img-fluid"
