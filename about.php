            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="sotcox-video-img mt-75">
                        ...
                        <!-- <a href="https://youtu.be/eHJnEHyyN1Y?si=jE_tt13auAou7IVZ" data-rel="lightcase" class="sotcox-video-btn">
 ...
 <div class="row justify-content-center pt-5">
    <div class="col-xl-6">
        <div class="sotcox-section-heading sotcox-section-heading__style-2 text-center mb-60">
            <span class="sub-heading">our Client</span>
            <h1 class="heading" style="font-size: 20px;">Our dedicated Client</h1>
        </div>
    </div>
</div>
<section
  class="client-scroller"
  style="background-color: #f8f9fa; padding: 20px 0; overflow: hidden;"
>

  <div
    class="container"
    style="max-width: 1200px; margin: 0 auto; display: flex; align-items: center; overflow-x: auto; white-space: nowrap;"
  >
  
    <div
      class="client-logo"
      style="display: inline-block; margin: 0 20px; flex: 0 0 auto; text-align: center;"
    >
      <img
        src="assets/img/bg/about-bg-1.jpg"
        alt="Client 1"
                ...
                <div class="col-xl-4 col-lg-10 col-md-12 align-self-center">
                    <div class="sotcox-section-heading sotcox-section-heading__style-2">
                        ...
                        <h4 class="heading mb-20">
                            Some number of our achivement</h4>
    ...
    <!-- <div class="sotcox-article-section pt-120 pb-130">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="sotcox-section-heading sotcox-section-heading__style-2 text-center mb-60">
                        <span class="sub-heading">blog</span>
                        <h2 class="heading">Read our latest tips & tricks</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="sotcox-article-item sotcox-article-item__style-2">
                            <div class="content">
                                ...
                                <div class="bottom">
                                    ...
                                    <button class="fvrt"><i class="fal fa-heart"></i> <span>55</span></button>
                                </div>
                            </div>
                            <div class="thumb">
                        ...
                        <div class="sotcox-article-item sotcox-article-item__style-2">
                            <div class="content">
                                ...
                                <div class="bottom">
                                    ...
                                    <button class="fvrt"><i class="fal fa-heart"></i> <span>50</span></button>
                                </div>
                            </div>
                            <div class="thumb">
